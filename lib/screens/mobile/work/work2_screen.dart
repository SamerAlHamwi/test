...
class _WorkPage2State extends State<WorkPage2> with AutomaticKeepAliveClientMixin {
  ...
  Future<bool> getCaptcha(int id) async {
    ...
    try {
      ...
      String errorMessage = e.response?.data['Message'] ?? 'حدث خطأ اثناء طلب المعادلة في الصفحة 2';
