...
class WorkPage1 extends StatefulWidget {
  ...
  @override
  _WorkPage1State createState() => _WorkPage1State();
}

class _WorkPage1State extends State<WorkPage1> with AutomaticKeepAliveClientMixin {
        ...
        body: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ElevatedButton(
                    onPressed: (){
                      getCaptcha(int.parse(SettingsData.getUser1Id1));
                    },
                    child: _isLoading
                        ? const Row(
            ...
            CustomKeyboard(
              ...
              onReserveTap: (){
                if(solveController.text.isNotEmpty){
                  reservePassport(int.parse(SettingsData.getUser1Id1), int.parse(solveController.text));
