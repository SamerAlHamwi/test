...
class AddProcessModel {
  ...
  Map<String, dynamic> toJson() {
    String formattedDate = DateFormat('yyyy-MM-dd').format(DateTime.parse(SettingsData.getUser1!.pPROFILERESULT!.bIRTHDATE!));
    ...
    json['P_FNAME'] = SettingsData.getUser1!.pPROFILERESULT!.fIRSTNAME ?? '';
    json['P_LNAME'] = SettingsData.getUser1!.pPROFILERESULT!.lASTNAME ?? '';
    json['P_FATHER'] = SettingsData.getUser1!.pPROFILERESULT!.fATHERNAME ?? '';
    json['P_MOTHER'] = SettingsData.getUser1!.pPROFILERESULT!.mOTHERNAME ?? '';
    json['P_COPIES'] = 1;
    json['P_SYRIAID'] = SettingsData.getUser1!.pPROFILERESULT!.nID ?? '';
    json['P_BIRTH_PLACE'] = SettingsData.getUser1!.pPROFILERESULT!.bIRTHPLACE ?? '';
    json['P_BIRTH_DATE'] =  formattedDate;
    json['P_REGISTNO'] = SettingsData.getUser1!.pPROFILERESULT!.kAIDNO ?? '';
    json['P_IDDOCNO'] = "";
    json['P_CENTERID'] = syriaLocations['$id']?['centerId'];
    json['P_MOBILE'] = SettingsData.getUser1!.pPROFILERESULT!.mOBILE ?? '';
    json['P_TEL'] = SettingsData.getUser1!.pPROFILERESULT!.mOBILE ?? '';
